...
div_lineas.style.background = '#ffffff';
div_lineas.style.border = '1px solid gray';
div_lineas.style.opacity = '0.8';
div_lineas.style.position = 'absolute';
div_lineas.style.padding = '10px';
div_lineas.style.paddingTop = '0px';
div_lineas.style.width = '20%';
div_lineas.style.minWidth = '200px';
div_lineas.style.top = '40px';
div_lineas.style.right = '20px';	
//var graph = ui.editor.graph;
	// Made for chromeless mode
	if (!ui.editor.chromeless)
	{
...
div_viewer.style.background = '#ffffff';
div_viewer.style.border = '1px solid gray';
div_viewer.style.opacity = '0.8';
div_viewer.style.position = 'absolute';
div_viewer.style.padding = '10px';
div_viewer.style.paddingTop = '0px';
div_viewer.style.width = '20%';
div_viewer.style.minWidth = '200px';
div_viewer.style.top = '40px';
div_viewer.style.right = '20px';	
//var graph = ui.editor.graph;
	// Made for chromeless mode
	if (!ui.editor.chromeless)
	{
...
div_timeline.style.background = '#ffffff';
div_timeline.style.border = '1px solid gray';
div_timeline.style.opacity = '0.8';
div_timeline.style.position = 'absolute';
div_timeline.style.padding = '10px';
div_timeline.style.paddingTop = '0px';
div_timeline.style.width = '20%';
div_timeline.style.minWidth = '200px';
div_timeline.style.top = '40px';
div_timeline.style.right = '20px';	
//var graph = ui.editor.graph;
	// Made for chromeless mode
	if (!ui.editor.chromeless)
	{
